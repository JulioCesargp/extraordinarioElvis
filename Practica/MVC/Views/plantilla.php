           ...
           <ul class="nav nav-justified py-2 nav-pills">
                <?php  if(isset($_GET["pagina"])): ?>
                        ...
                        <!--
                            ...
                            (tambien conocido cmo cadena de consulta a través de la URL)
                            cuando es la primera varible se separa con este signo ?
                            las que siguen a continuación se separan con amperson &
                        -->
                    <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link active" href="index.php?pagina=registro">Registro</a>
...
<!--Contenido-->
   ...
   <div class="container-fluid">
       <div class="container py-5">
        ...
        #ISSET: Isset()Determina si una varible esta definida o  no esta definida , y además no es null
